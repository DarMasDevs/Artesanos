        ...
        <div className="flex items-center space-x-3">
          {navlinks.map((link, index) => (
            <div key={index} className="group relative">
              ...
              {link.sublinks && (
                <div className="pointer-events-none absolute left-0 mt-2 w-48 rounded-md bg-white opacity-0 shadow-lg transition-opacity duration-300 group-hover:pointer-events-auto group-hover:opacity-100">
